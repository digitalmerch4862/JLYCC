...
export default function Events() {
  const { content } = useContent('events', {
              ...
              <div className="flex-1 p-8">
                ...
                <div className="flex items-center gap-4">
                  ...
                  <motion.button
                    whileHover={{ scale: 1.02 }}
                    whileTap={{ scale: 0.98 }}
                    className="py-3 px-6 rounded-xl font-bold text-jly-blue border-2 border-gray-200 hover:border-jly-blue transition-all uppercase tracking-widest text-xs"
                  >
                    Details
                  </motion.button>
                </div>
