...
export const dummyUsers: User[] = [
  ...
  { id: '2', name: 'Bob Smith', role: 'Inner Core', email: 'bob@example.com', phone: '234-567-8901' },
  { id: '3', name: 'Charlie Brown', role: 'Joshua Gen', email: 'charlie@example.com', phone: '345-678-9012' },
